...
#define TOKEN_X_MACRO\
  ...
  X(TOKEN_CHAR,    TOKEN_FLAG_CONSTANT)\
...
\
  ...
  X(TOKEN_COLLON_X2, 0)\
\
  X(TOKEN_FUN,      TOKEN_FLAG_KEYWORD|TOKEN_FLAG_DECLARATOR)\
\
...
\
  X(TOKEN_NEWLINE, TOKEN_FLAG_BREAKING|TOKEN_FLAG_SEPARATOR|TOKEN_FLAG_FINISHER)\
  X(TOKEN_COMMA, TOKEN_FLAG_BREAKING|TOKEN_FLAG_SEPARATOR)\
  X(TOKEN_SEMICOLLON, TOKEN_FLAG_BREAKING|TOKEN_FLAG_SEPARATOR)\
\
